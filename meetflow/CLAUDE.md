...
- Lambda設計書v1.9（8ドメイン構成、IAM権限は「案C」を採用）
- API設計書v1.30
- 画面設計書v1.18
- エラーコード一覧v1.11
- AWSシステム構成設計書v1.3
